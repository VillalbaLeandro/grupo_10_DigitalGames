...
-- Commented out: plpgsql is already installed by default in PostgreSQL
...
-- Commented out: extension already exists
...
--
-- Name: _compatibilities; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._compatibilities (
    id smallint,
    name character varying(15) DEFAULT NULL::character varying
);


-- ALTER TABLE public._compatibilities OWNER TO rebasedata;

--
-- Name: _compatibilities_has_products; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._compatibilities_has_products (
    id smallint,
    compatibilities_id smallint,
    products_id smallint
);


-- ALTER TABLE public._compatibilities_has_products OWNER TO rebasedata;

--
-- Name: _genders; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._genders (
    id smallint,
    name character varying(10) DEFAULT NULL::character varying
);


-- ALTER TABLE public._genders OWNER TO rebasedata;

--
-- Name: _lenguages; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._lenguages (
    id smallint,
    name character varying(13) DEFAULT NULL::character varying
);


-- ALTER TABLE public._lenguages OWNER TO rebasedata;

--
-- Name: _permissions; Type: TABLE; Schema: public; Owner: rebasedata
--
...
-- ALTER TABLE public._permissions OWNER TO rebasedata;
...
CREATE TABLE public._products (
    id smallint,
    name character varying(28) DEFAULT NULL::character varying,
    releasedata character varying(19) DEFAULT NULL::character varying,
    img character varying(19023) DEFAULT NULL::character varying,
    fullname character varying(38) DEFAULT NULL::character varying,
    description character varying(2440) DEFAULT NULL::character varying,
    discount smallint,
    "freeShipping" smallint,
    price integer,
    capture1 character varying(166) DEFAULT NULL::character varying,
    capture2 character varying(166) DEFAULT NULL::character varying,
    capture3 character varying(166) DEFAULT NULL::character varying,
    capture4 character varying(166) DEFAULT NULL::character varying,
    video character varying(78) DEFAULT NULL::character varying
);
...
--
-- Name: _products_has_genders; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._products_has_genders (
    id smallint,
    products_id smallint,
    genders_id smallint
);
...
-- ALTER TABLE public._products_has_genders OWNER TO rebasedata;

--
-- Name: _products_has_lenguages; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._products_has_lenguages (
    products_id smallint,
    lenguages_id smallint,
    id smallint
);


-- ALTER TABLE public._products_has_lenguages OWNER TO rebasedata;

--
-- Name: _products_has_players; Type: TABLE; Schema: public; Owner: rebasedata
--

CREATE TABLE public._products_has_players (
    products_id smallint,
    players_id smallint,
    id smallint
);
...
-- ALTER TABLE public._products_has_players OWNER TO rebasedata;
...
CREATE TABLE public._roles (
    id smallint,
    roll character varying(8) DEFAULT NULL::character varying,
    estado smallint
);
...
CREATE TABLE public._users (
    id smallint,
    full_name character varying(17) DEFAULT NULL::character varying,
    ...
    img_profile character varying(50) DEFAULT NULL::character varying,
    roles_id smallint
);
...
--
-- Data for Name: _compatibilities; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._compatibilities (id, name) FROM stdin;
1	PS3
2	PS4
3	PS5
4	XBOX ONE
...
--
-- Data for Name: _compatibilities_has_products; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._compatibilities_has_products (id, compatibilities_id, products_id) FROM stdin;
15	2	16
16	3	16
17	4	16
18	2	17
...
--
-- Data for Name: _genders; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._genders (id, name) FROM stdin;
1	Accion
2	Arcade
3	Carreras
4	Deportes
...
--
-- Data for Name: _lenguages; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._lenguages (id, name) FROM stdin;
1	Español
2	Ingles
3	Otro
4	Multilenguaje
...
--
-- Data for Name: _permissions; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._permissions (id, name) FROM stdin;
\.
...
COPY public._players (id, name) FROM stdin;
1	1 Jugador
2	Multijugador
3	Cooperativo
4	Mundo Abierto
...
COPY public._products (id, name, releasedata, img, fullname, description, discount, "freeShipping", price, capture1, capture2, capture3, capture4, video) FROM stdin;
...
--
-- Data for Name: _products_has_genders; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._products_has_genders (id, products_id, genders_id) FROM stdin;
15	16	1
16	16	5
17	16	6
18	17	1
...
--
-- Data for Name: _products_has_lenguages; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._products_has_lenguages (products_id, lenguages_id, id) FROM stdin;
16	1	10
16	2	11
17	1	12
17	2	13
...
--
-- Data for Name: _products_has_players; Type: TABLE DATA; Schema: public; Owner: rebasedata
--

COPY public._products_has_players (products_id, players_id, id) FROM stdin;
16	1	13
16	3	14
17	1	15
18	1	16
...
COPY public._roles (id, roll, estado) FROM stdin;
1	admin	1
2	vendedor	1
3	user	1
\.
...
COPY public._users (id, full_name, email, password, address, img_profile, roles_id) FROM stdin;
9	Leandro villalba	exemprary@gmail.com	$2b$10$7M.3806oVUOqB1uNxjYUIeLDNXZAR4luCnKIQib.qLh5kfauPx.Xu		1667643577309_img_.jpg	1
10	Ignacio Menguez	nachomenguez22@gmail.com	$2b$10$duL4PN1.PE4MouK/wDdVIOa8e0k4Z2qGFlGTIeVh07BprS2AUBaeC		199768201_691792018849576_145844266768873327_n.jpg	1
11	julieta baez	julietabaez@gmail.com	$2b$10$.wKnRoDSGKI/JwgsZGOvaO0u4H7f/J8nj6Dayb8iISY8IfL0Jb4FG		default.jpg	3
