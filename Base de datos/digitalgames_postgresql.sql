...
-- CREATE DATABASE IF NOT EXISTS  digitalgames_db ;
-- \c digitalgames_db;
...
CREATE TABLE products (
  "id" SERIAL PRIMARY KEY,
  "name" VARCHAR(256) NOT NULL,
  "releaseData" TIMESTAMP NOT NULL,
  "img" TEXT NOT NULL,
...
DROP TABLE IF EXISTS lenguages CASCADE;
...
--
DROP TABLE IF EXISTS products_has_genders CASCADE;

CREATE TABLE products_has_genders (
  products_id INTEGER NOT NULL,
  genders_id INTEGER NOT NULL,
  PRIMARY KEY (products_id, genders_id),
  FOREIGN KEY (products_id) REFERENCES products(id) ON DELETE CASCADE,
  FOREIGN KEY (genders_id) REFERENCES genders(id) ON DELETE CASCADE
);

INSERT INTO products_has_genders (products_id, genders_id) VALUES
(16, 1),
(16, 5),
(16, 6),
(17, 1),
...
DROP TABLE IF EXISTS products_has_lenguages CASCADE;

CREATE TABLE products_has_lenguages (
  products_id INTEGER NOT NULL,
  lenguages_id INTEGER NOT NULL,
  PRIMARY KEY (products_id, lenguages_id),
  FOREIGN KEY (products_id) REFERENCES products(id) ON DELETE CASCADE,
  FOREIGN KEY (lenguages_id) REFERENCES lenguages(id) ON DELETE CASCADE
);

INSERT INTO products_has_lenguages (products_id, lenguages_id) VALUES
(16, 1),
(16, 2),
(17, 1),
(17, 2),
...
DROP TABLE IF EXISTS products_has_players CASCADE;

CREATE TABLE products_has_players (
  products_id INTEGER NOT NULL,
  players_id INTEGER NOT NULL,
  PRIMARY KEY (products_id, players_id),
  FOREIGN KEY (products_id) REFERENCES products(id) ON DELETE CASCADE,
  FOREIGN KEY (players_id) REFERENCES players(id) ON DELETE CASCADE
);

INSERT INTO products_has_players (products_id, players_id) VALUES
(16, 1),
(16, 3),
(17, 1),
(18, 1),
...
SELECT setval('compatibilities_id_seq', (SELECT MAX(id) FROM compatibilities));
SELECT setval('genders_id_seq', (SELECT MAX(id) FROM genders));
SELECT setval('lenguages_id_seq', (SELECT MAX(id) FROM lenguages));
SELECT setval('players_id_seq', (SELECT MAX(id) FROM players));
SELECT setval('products_id_seq', (SELECT MAX(id) FROM products));
SELECT setval('roles_id_seq', (SELECT MAX(id) FROM roles));
-- permissions no tiene datos, no es necesario resetear pero se deja por consistencia si hubiera
